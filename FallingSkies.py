...
wn = turtle.Screen()
wn.title("Falling Skies by MeroMero")
wn.bgcolor("green")
wn.bgpic("/Users/h205p2/Desktop/Pycharm/background.gif")
...
for _ in range(20):
    ...
    good_guy.speed = random.randint(2, 6)
...
for _ in range(20):
    ...
    bad_guy.speed = random.randint(2, 6)
